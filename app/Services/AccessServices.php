...
class AccessServices
{
    ...
    public function getOnlineAccessesByCongressIdPginantion($congressId, $offset, $perPage, $search, $date, $startTime, $endTime, $myAccesses, $user_id)
    {
        ...
        ->where(function ($query) use ($user_id, $myAccesses) {
            if ($myAccesses == 1) {
