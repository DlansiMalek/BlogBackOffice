...
class CongressServices
{
                        ...
                        $submissionTitle = null, $communication_type = null, $submissions = [],$submissionComment=null,$linkSubmission=null,$linkPrincipalRoom = null, $meeting=null, $user_receiver=null, $user_sender=null,$verification_code = null)
    {
        ...
        $template = str_replace('{{$meeting-&gt;meeting_table-&gt;label}}', '{{$meeting->meeting_table->label}}', $template);
        ...
        $linkAcceptMeeting =  UrlUtils::getBaseUrl() . '/meetings/'. $meeting->meeting_id .'/update-status?status=1&verification_code='.$verification_code  ;
        $linkRefuseMeeting =  UrlUtils::getBaseUrl() . '/meetings/'. $meeting->meeting_id .'/update-status?status=-1&verification_code='.$verification_code ;
