...
class CongressServices
{
    ...
    function renderMail($template, $congress, $participant, $link, $organization, $userPayment, $meeting_id=null, $user_receiver=null, $user_sender=null, $linkSondage = null, $linkFrontOffice = null, $linkModerateur = null, $linkInvitees = null, $room = null, $linkFiles = null, $submissionCode = null,
                        $submissionTitle = null, $communication_type = null, $submissions = [],$submissionComment=null,$linkSubmission=null,$linkPrincipalRoom = null)
    {
        ...
        $linkAcceptMeeting =  UrlUtils::getBaseUrl() . '/meetings/update?congress_id=' . $congress->congress_id . '&user_received_id=' . $user_receiver->user_id .'&user_sender_id=' . $user_sender->user_id . '&meeting_id=' . $meeting_id . '&status=1' ;
        $linkRefuseMeeting =  UrlUtils::getBaseUrl() . '/meetings/update?congress_id=' . $congress->congress_id . '&user_received_id=' . $user_receiver->user_id .'&user_sender_id=' . $user_sender->user_id . '&meeting_id=' . $meeting_id . '&status=-1' ;
