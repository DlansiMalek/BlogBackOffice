...
class CongressServices
{
                        ...
                        $submissionTitle = null, $communication_type = null, $submissions = [],$submissionComment=null,$linkSubmission=null,$linkPrincipalRoom = null, $meeting=null, $user_receiver=null, $user_sender=null,$verification_code = null)
    {
        ...
        $linkAcceptMeeting = $verification_code !=null?  UrlUtils::getBaseUrl() . '/meetings/'. $meeting->meeting_id .'/update-status?status=1&verification_code='.$verification_code : null ;
        $linkRefuseMeeting = $verification_code !=null?  UrlUtils::getBaseUrl() . '/meetings/'. $meeting->meeting_id .'/update-status?status=-1&verification_code='.$verification_code : null ;
